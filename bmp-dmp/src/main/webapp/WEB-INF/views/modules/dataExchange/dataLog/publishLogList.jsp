...
<div class="bo_main txq_main">
    <div class="mgtb10">
    	<sf:form id="search_form"  modelAttribute="queryBean" name="search_form" action="${ctx }/dataExchange/publishLogList" method="post">
	        <div class="clearfix mgtb10">
		        	...
		        	<p class="fl mgr10"><span>数据ID</span> <input type="text" style="width:160px;" class="def_inp" id="objId" name="objId" value="${queryBean.objId }"/></p>
...
function doWatch(id){
	var dialog = top.art.dialog.open({
		...
		id:'addFrame',
		title: '查看数据',
	    content: '${ctx}/dataExchange/doWatchDetail?id='+id+'&type='+0,
	    width:'420px',
		height:'400px',
		padding:'5px',
		scrolling:'yes',
