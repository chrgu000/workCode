...
<body>
	<div class="mgtb10">
    	<sf:form action="${ctx}/admin/dataSave" modelAttribute="objBean" method="post" id="updateFrame" name="updateFrame" class="txq_infor">
    		<input type="hidden" name="id" id="id" value="${objBean.id}">
          	<table border="0" width="100%">
              <tr>
                <td align="right">数据名称</td>
                <td><input type="text" id="name" name="name"  value="${objBean.name}" class="def_inp" placeholder="数据名称" style="width: 160px;" /> <span><em class="red">*</em></span></td>
              </tr>
              <tr>
                <td align="right">数据编码</td>
                <td><input type="text" id="code" name="code" value="${objBean.code}" class="def_inp" placeholder="数据编码" style="width: 160px;" /> <span><em class="red">*</em></span></td>
              </tr>
              <tr>
              	<td align="right">数据类型</td>
                <td> 
                	<sf:select path="dataType" class="def_sel" value="${objBean.dataType}" style="width:182px;">
              ...
              <tr>
                ...
                <td>
                	<input type="text" id="createTime" name="createTime" value="<fmt:formatDate value="${objBean.createTime}" type="both"/>"  onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'createTime\')||\'2020-10-01\'}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width:160px;" class="Wdate"><span>
              ...
              <tr>
                ...
                <td>
                	<input type="text" id="updateTime" name="updateTime" value="<fmt:formatDate value="${objBean.updateTime }" type="both"/>"  onfocus="WdatePicker({maxDate:'#F{$dp.$D(\'updateTime\')||\'2020-10-01\'}',dateFmt:'yyyy-MM-dd HH:mm:ss'})" style="width:160px;" class="Wdate"><span>
                	<em class="red">*</em></span>
                </td>
              </tr>
            </table>
...
<script type="text/javascript">
	...
	function jobAdd(){
		if($("#updateFrame").valid()) {
			var data = $("#updateFrame").serialize();
			$.ajax({
	               "type" : "post",  
