	...
	<div class="mgtb10">
    	<form action="${ctx}/admin/dictSave" method="post" id="addForm" name="addForm" class="txq_infor">
              ...
              <tr>
                ...
                <td><input type="text" id="name" name="name" class="def_inp" placeholder="字典名称" style="width: 160px;" /> <span><em class="red">*</em></span></td>
              </tr>
              <tr>
                <td align="right">字典键</td>
                <td><input type="text" id="key" name="key" class="def_inp" placeholder="字典键" style="width: 160px;" /> <span><em class="red">*</em></span></td>
              </tr>
              <tr>
              	<td align="right">字典值</td>
                <td><input type="text" id="value" name="value" class="def_inp" placeholder="字典值" style="width:160px;"/> <span><em class="red">*</em></span></td>
              </tr>
              <tr>
              	<td align="right">字典类型</td>
                <td><input type="text" id="type" name="type"  class="def_inp" placeholder="字典类型" style="width: 160px;"/> <span><em class="red">*</em></span></td>
              </tr>
            </table>
        </form>
    </div>
