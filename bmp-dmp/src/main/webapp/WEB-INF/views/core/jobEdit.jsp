...
<body>
	<div class="mgtb10">
    	<sf:form action="${ctx}/core/jobSave" modelAttribute="quartzJobVo" method="post" id="jobAddForm" name="jobAddForm" class="txq_infor">
    		<input type="hidden" id="id" name="id" value="${quartzJobVo.id }">
          	<table border="0" width="100%">
              <tr>
                <td align="right">任务名</td>
                <td><input type="text" id="jobName" name="jobName" value="${quartzJobVo.jobName }" style="width: 160px;" class="def_inp" placeholder="任务名"/> <span><em class="red">*</em></span></td>
              	<td align="right">任务组</td>
                <td><input type="text" id="jobGroup" name="jobGroup" value="${quartzJobVo.jobGroup }" class="def_inp" placeholder="任务组" style="width:160px;"/> <span><em class="red">*</em></span></td>
              </tr>
              <tr>
                <td align="right">目标对象</td>
                <td><input type="text" id="targetObject" name="targetObject" value="${quartzJobVo.targetObject }" style="width: 160px;" class="def_inp" placeholder="springBean对象"/></td>
              	<td align="right">目标方法</td>
                <td><input type="text" id="targetMethod" name="targetMethod" value="${quartzJobVo.targetMethod }"  class="def_inp" placeholder="springBean方法" style="width:160px;"/> <span><em class="red">*</em></span></td>
              </tr>
              <tr>
              	<td align="right">时间表达式</td>
                <td><input type="text" id="cronExpression" name="cronExpression" value="${quartzJobVo.cronExpression }" style="width: 160px;" class="def_inp" placeholder="0/5 * * * * ?"/> <span><em class="red">*</em></span></td>
              ...
              <tr>
                ...
                <td>
                	<input type="text" id="description" name="description" value="${quartzJobVo.description }" class="def_inp" placeholder="任务描述" style="width:160px;"/>
                </td>
              </tr>
            </table>
        </sf:form>
